...
public class ProfessorOnlineJUnit {
	...
	@Test
	public void testValidateUser02() throws Exception {
		User user = new User();
	...
	public void testInsertClassRecord01() {
		ClassRecord classRecord = new ClassRecord();
		//Date now = new Date();
		boolean output = classRecord.insertClassRecord("20192", "1", 2, "aaa");
		assertTrue(output);
	}
	...
	public void testInsertClassRecord02() {
		ClassRecord classRecord = new ClassRecord();
		//Date now = new Date();
		boolean output = classRecord.insertClassRecord("20192", "2", 2, "");
		assertFalse(output);
	}
