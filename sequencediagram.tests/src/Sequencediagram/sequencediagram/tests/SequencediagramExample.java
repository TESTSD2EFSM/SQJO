...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>sequencediagram</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SequencediagramExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(SequencediagramPackage.eNS_URI, 
			 SequencediagramPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.sequencediagram"));
				SequenceDiagram root = SequencediagramFactory.eINSTANCE.createSequenceDiagram();
