...
/**
 * This is the item provider adapter for a {@link Efsm.efsm.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						EfsmPackage.Literals.INPUT__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EfsmPackage.Literals.INPUT__VARIABLES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case EfsmPackage.INPUT__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case EfsmPackage.INPUT__VARIABLES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(EfsmPackage.Literals.INPUT__VARIABLES, EfsmFactory.eINSTANCE.createVariable()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return EfsmEditPlugin.INSTANCE;
	}
